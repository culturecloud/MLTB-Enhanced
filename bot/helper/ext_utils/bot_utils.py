...
def get_proxied_image_url(url):
    return f"https://images.culturecloud.eu.org/?url={url}&w=1280&default=https://placekitten.com/g/1280/720"
...
async def get_stats(event, key="home"):
    ...
    if key == "home":
        ...
        official_v = (await cmd_exec(f"curl -o latestversion.py https://raw.githubusercontent.com/weebzone/WZML-X/master/bot/version.py -s && python3 latestversion.py && rm latestversion.py", True))[0]
